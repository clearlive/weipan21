...
class Api extends Controller{
	...
	public function getkdata($pid=null,$num=null,$interval=null,$isres=null)
	{
		...
		//比特币
		if(in_array($pro['procode'],array("btc","ltc","eth"))){
			...
			$geturl = "https://www.okex.com/api/klineData.do?marketFrom=".$From."&type=".$datalen."&limit=".$num."&coinVol=0";////20171102---------------------
