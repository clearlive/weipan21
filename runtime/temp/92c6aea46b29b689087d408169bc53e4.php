<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\goods\huishou.html";i:1536835722;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="numeric">    
                                       <a class="btn btn-danger btn-xs" onclick="hyinfo('<?php echo $vo['pid']; ?>')">点击还原</a>
                                  </td>
                              </tr>
...
//hy info
	function hyinfo(id){
		layer.open({
		  ...
		  yes: function(index){
		    //do something
		    var url = "<?php echo url('goods/hypro'); ?>"+"?id="+id;
		    var locurl = "<?php echo Url('admin/goods/prolist'); ?>"
		    WPget(url,locurl);
		  }
		});
