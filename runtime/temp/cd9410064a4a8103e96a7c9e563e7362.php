<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\goods\proclass.html";i:1536835722;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
            ...
            <header class="panel-heading">
               产品列表
                            ...
                            <div class="text-center pull-right " style="margin-top: -0.5rem;">
								<a href="<?php echo url('goods/proadd'); ?>"  class="btn btn-success">    添加分类+</a>
                      		</div>
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                      	<!-- <?php if(is_array($productclass) || $productclass instanceof \think\Collection || $productclass instanceof \think\Paginator): $i = 0; $__LIST__ = $productclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  <td class="numeric"><?php echo $vo['pcid']; ?></td>
