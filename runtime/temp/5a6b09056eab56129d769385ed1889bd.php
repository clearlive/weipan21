<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\user\userprice.html";i:1553699962;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<section class="wrapper">
   ...
   <!--body wrapper start-->
		...
		<div style="margin-bottom: 20px;">
          <a href="<?php echo url('user/userprice'); ?>"><button class="btn btn-danger" type="submit">搜索 全部</button></a> <a ><button class="btn btn-danger" type="submit">充值总金额：<?php echo $all_bpprice; ?></button></a>
     	</div>	
                        ...
                        <tbody>
							<!-- <?php if(is_array($balance) || $balance instanceof \think\Collection || $balance instanceof \think\Paginator): $i = 0; $__LIST__ = $balance;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td class="color_red">¥<?php echo round($vo['bpprice']*($bl['rmbcoin']/$bl['gamecoin']),2); ?></td>
                                  ...
                                  <td><?php if($vo['bptype'] == 1): ?>
                                      ...
                                      <?php elseif($vo['bptype'] == 0 && $vo['isverified'] == 2): ?>
	                                  	...
	                                  	<?php elseif($vo['bptype'] == 3 && $vo['isverified'] == 0): ?>
	                                  	<button class="btn btn-primary btn-xs price" data-toggle="modal" data-bpid="<?php echo $vo['bpid']; ?>" data-userid="<?php echo $vo['uid']; ?>" data-target="#myModal2">
...
var adminpwd = '';
    ...
    function dorecharge2(){
    	...
    	var formurl = "<?php echo Url('user/dorecharge2'); ?>";
