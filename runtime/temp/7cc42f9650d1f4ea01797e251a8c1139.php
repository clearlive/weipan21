...
<section class="wrapper">
   ...
   <!--body wrapper start-->
		...
		<div style="margin-bottom: 20px;">
          <a href="<?php echo url('price/allot'); ?>"><button class="btn btn-danger" type="submit">搜索 全部</button></a> 
     	</div>	
