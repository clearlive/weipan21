<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\system\rechargerate.html";i:1552918530;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <tbody>
                            <!-- <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><?php echo $vo['rmbcoin']; ?></td>
                                  <td><?php echo $vo['gamecoin']; ?></td>
                                  <td><?php echo $vo['mark']; ?></td>
                                  <td>
                                      <a href="<?php echo url('system/rateInfo',array('rid'=>$vo['rid'])); ?>"><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
                                  </td>
                              </tr>
