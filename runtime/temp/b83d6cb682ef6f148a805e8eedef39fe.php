<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/index\view\user\index.html";i:1555483611;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/index\view\head-gaiban.html";i:1529895948;s:73:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/index\view\foot.html";i:1553174720;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="sticky-header user-body">
                            ...
                            <div class="col-md-12">
                                <div class="user-body-top">
                                    ...
                                    <div class="user-top-grzc">
                                        <span>个人资产：</span>
                                        <img src="__HOME__/img/dd-ye.png"
                                            alt=""><b><?php echo $userinfo['userdollor']; ?></b><span>USDT</span>
                                    ...
                                    <div class="user-body-middle">
                                        <ul class="clearfix">
                                            <li>
                                                <a  data-toggle="modal" id="tixian">
                                                    <div class="tb">提币已锁定</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="modal" id="chongzhi">
                                                    <div class="cz">充值已锁定</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <a href="#myModal3" data-toggle="modal">
                            <section class="ico-bottom panel">
                                <div class="panel-body">
                                    ...
                                    <div class="ico-title">
                                        <h5><img src="__HOME__/img/user-zj.png" alt="">资金流水<img
                        ...
                        <a href="<?php echo url('/index/login/respass'); ?>">
                            <section class="ico-bottom panel">
                                <div class="panel-body">
                                    ...
                                    <div class="ico-title">
                                        <h5><img src="__HOME__/img/user-sz.png" alt="">修改密码<img
