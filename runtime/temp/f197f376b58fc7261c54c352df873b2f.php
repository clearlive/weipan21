                          ...
                          <?php if($bank): ?>
                              ...
                              <div class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $bank['id']; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">持卡人姓名：</label>
                                      <div class="col-lg-6">
                                  ...
                                  <div class="form-group">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">预留手机号：</label>
                                      <div class="col-lg-6">
