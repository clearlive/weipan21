<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\setup\proportion.html";i:1555564915;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555507465;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <form class="form-horizontal adminex-form"  role="form" action="" method="post" id="formid" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label"><?php echo $d['title']; ?></label>
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-lg-10">
                                    <input type="text"  class="form-control" placeholder="<?php echo $d['title']; ?>"  name="<?php echo $d['name']; ?>" value="<?php echo !empty($d['value'])?$d['value']:''; ?>">
                                </div>
                            </div>                        	
                        </div>
                    </div>
       			...
       			<div class="panel-body">
                   <input type="submit" class="btn btn-primary"   onclick="return   editconf1(this.form)" value="提交">
                </div>
...
function editconf1(form) {
  
  var formurl = "<?php echo Url('Setup/editconf1'); ?>"
    var data = $('#formid').serialize();
    var locurl = "<?php echo Url('Setup/proportion'); ?>";
