...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            ...
            <a href="<?php echo url('order/holdlist'); ?>"><button type="submit" class="btn btn-danger">搜索全部</button></a>&nbsp;&nbsp;&nbsp;&nbsp; <span class="color_red">&nbsp;&nbsp;<strong>默认为当天订单</strong></span>
<?php if(input('type') == 1): ?>
