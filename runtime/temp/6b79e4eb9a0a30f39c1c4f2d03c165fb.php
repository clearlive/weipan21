<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:113:"C:\Users\Administrator\Desktop\youpi\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/dlht\view\login\login.html";i:1555742638;}*/ ?>
<!DOCTYPE html>
...
<body>
      ...
      function check_admin_login (form)
   {
      ...
      var formurl = "<?php echo Url('dlht/login/login'); ?>"
      var data = $('#formid').serialize();
      $.post(formurl,data,function(data){
        if (data.type == 1) {

          layer.msg(data.data, {icon: 1,time: 1000},function(){
            window.location.href="<?php echo Url('dlht/index/index'); ?>";
          }); 
