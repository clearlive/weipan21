<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\code\weipan21_2019-4-18\weipan21/application/index\view\user\cashlist.html";i:1553052864;s:75:"C:\code\weipan21_2019-4-18\weipan21/application/index\view\head-gaiban.html";i:1529895948;s:68:"C:\code\weipan21_2019-4-18\weipan21/application/index\view\foot.html";i:1555586984;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="sticky-header">
 <section>
  	<div class="main-content" style="margin-left:0px;" >
        ...
        <!--头部导航文字-->
        	<h3 style="text-align: center;height: 16px;line-height: 10px;font-size: 18px;font-weight: 500;color: #333333;">提现列表</h3>
		<!--头部导航文字-->
        </div>		
		<div class="wrapper">		
			<div class="row">
                                      ...
                                      <div class="tab-pane active slider-left  " id="home"   data-index="0" >
                                              <ul class="activity-list">
                                                   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                	<li>
                                                      <div class="activity-desk" style="width: 100%;">
                                                          <h5 style="color:#333;font-size:18px" >提现金额：&yen;<?php echo $vo['bpprice']; ?></h5>
                                                      	  <p class="text-muted">状态： <?php if($vo['bptype'] == 0 && $vo['isverified'] == 0): ?>
                                                               <span style="color:#31B17A">审核中</span> 
                                                            <?php elseif($vo['bptype'] == 0 && $vo['isverified'] == 2): ?>
                                                            <span style="color:red">已拒绝</span> 
                                                            <?php else: ?>
                                                            <span style="color:#31B17A">已通过</span> 
                                                            <?php endif; ?></p>
                                                          <p><?php echo $vo['balance_sn']; ?></p>
