<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\system\dbbase.html";i:1529895948;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
             ...
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tbody>
                              <!-- <?php if(is_array($database) || $database instanceof \think\Collection || $database instanceof \think\Paginator): $i = 0; $__LIST__ = $database;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  <td><?php echo $vo['id']; ?></td>
                                  <td><?php echo $vo['time']; ?> </td>
                                  <td><?php echo $vo['filename']; ?></td>
                                  <td>
                                     <a href="<?php echo url('backupsbase',['tp'=>'dowonload','name'=>$vo['filename']]); ?>"><button class="btn btn-success btn-xs"><i class="icon-cloud-download"></i></button></a>
                                     <button class="btn btn-danger btn-xs" onclick="handle('del','<?php echo $vo['filename']; ?>')"><i class="icon-trash "></i></button>
                                     <!-- <button class="btn btn-primary btn-xs" onclick="handle('restore','<?php echo $vo['filename']; ?>')">还原</button> -->
                                  </td>
                              </tr>
...
<script>
    function handle(tp,name=''){        
        if (tp){
            $.post("<?php echo url('backupsbase'); ?>",{tp:tp,name:name},function(response){
                if (response){
                    layer.msg(response, {icon: 1,time: 2000},function(){
                      window.location.href="<?php echo Url('system/dbbase'); ?>";
                    });
                }else{
