<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\user\myteam.html";i:1541673474;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\head.html";i:1529895946;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\menu.html";i:1555567196;s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\weipan21/application/admin\view\foot.html";i:1529895946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                        ...
                        <div class="panel-heading">
                          我的团队
                            ...
                            <div class="div_my_son">
                              <ul class="my_sons">
                                <li>代理名：<?php echo $mysons['username']; ?> 余额：<?php echo $mysons['usermoney']; ?></li>
                                <li>手机：<?php echo $mysons['utel']; ?> <a href="/admin/user/userlist.html?uid=<?php echo $mysons['uid']; ?>"><button class="btn btn-primary btn-xs">详情</button></a></li>
                              </ul>
                              <a href="javascript:;"><p class="showdiv show_uid_<?php echo $mysons['uid']; ?>" onclick="showoid(<?php echo $mysons['uid']; ?>,1)" >+</p></a>
                            </div>
                            <?php echo set_my_team_html($mysons['mysons']); ?>
...
function showoid(oid,type){
  ...
  if(type == 1){
    ...
    $('.show_uid_'+oid).attr('onclick',"showoid("+oid+",0)")
    $('.show_uid_'+oid).html('-');
  }else{
    $('.foid_'+oid+' .oid_list').hide();
    $('.oid_'+oid+' .oid_list').hide();
    $('.show_uid_'+oid).attr('onclick',"showoid("+oid+",1)")
    $('.show_uid_'+oid).html('+');
  }
